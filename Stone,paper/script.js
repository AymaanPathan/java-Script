...
function select(playerChoice){
   ...
   console.log(`Player Choice:${playerChoice} || Cpu Choice:${computerChoice}`)
   if(playerChoice===computerChoice) {
    ...
    if (choice && choice.defeat.indexOf(computerChoice) !== -1) {
        resultText.textContent = "You Win!😃";
        playerScore++;
        playerScoreEl.textContent = playerScore;
        startConfetti();
    } else if(choice && choice.defeat.indexOf(computerChoice) === -1) {
        removeConfetti()
